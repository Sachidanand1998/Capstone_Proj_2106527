...
import com.capstone.project.movieappbackend.services.UserService;
...
public class UserController {
    ...
    public ResponseEntity<String> saveUser(@RequestBody User user) {
        ...
        } catch (com.capstone.project.movieappbackend.exceptions.EmailIdAlreadyExistsException exception) {
    ...
    private String generateToken(String emailId) {
        return Jwts.builder().setSubject(emailId).signWith(SignatureAlgorithm.HS256, "CTS-MOVIEAPP").compact();
    }
}